...
public:
	static void Init()
	{
		...
		GPacketHandler_Tcp[PKT_S_SYNC_ROOMLIST] = [](SessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<TcpPacketHeader, Protocol::S_SYNC_ROOMLIST> (Handle_S_SYNC_ROOMLIST, session, buffer, len); };
		GPacketHandler_Udp[PKT_S_SYNC_ROOMLIST] = [](SessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<UdpPacketHeader, Protocol::S_SYNC_ROOMLIST> (Handle_S_SYNC_ROOMLIST, session, buffer, len); };
		...
		GPacketHandler_Tcp[PKT_S_HIT_RESULT] = [](SessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<TcpPacketHeader, Protocol::S_HIT_RESULT> (Handle_S_HIT_RESULT, session, buffer, len); };
		GPacketHandler_Udp[PKT_S_HIT_RESULT] = [](SessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<UdpPacketHeader, Protocol::S_HIT_RESULT> (Handle_S_HIT_RESULT, session, buffer, len); };
	}
	...
	static SendBufferRef MakeSendBufferTcp(Protocol::C_SYNC_ROOMLIST& pkt) { return MakeSendBufferImpl<TcpPacketHeader>(pkt, PKT_C_SYNC_ROOMLIST); }
	static SendBufferRef MakeSendBufferUdp(Protocol::C_SYNC_ROOMLIST& pkt) { return MakeSendBufferImpl<UdpPacketHeader>(pkt, PKT_C_SYNC_ROOMLIST); }
	...
	static SendBufferRef MakeSendBufferTcp(Protocol::C_HIT_RESULT& pkt) { return MakeSendBufferImpl<TcpPacketHeader>(pkt, PKT_C_HIT_RESULT); }
	static SendBufferRef MakeSendBufferUdp(Protocol::C_HIT_RESULT& pkt) { return MakeSendBufferImpl<UdpPacketHeader>(pkt, PKT_C_HIT_RESULT); }
